...
public class SimulasiMotorSinic {
    boolean nyala;
    int porseneling;
    int kecepatan;
    SimulasiMotorSinic(){
        ...
        if(nyala == true){
            ...
            if(porseneling == 0){
                ...
                if(kecepatan + jumlah_kecepatan > 10){
                    System.out.println("kecepatan akan melebihi kecepatan maksimal di gigi 1");
                }
                else{
                ...
                if(kecepatan + jumlah_kecepatan > 25){
                    System.out.println("kecepatan akan melebihi kecepatan maksimal di gigi 2");
                }
                ...
                if(kecepatan + jumlah_kecepatan > 50){
                    System.out.println("kecepatan akan melebihi kecepatan maksimal di gigi 3");
                }
                else{
                    kecepatan += jumlah_kecepatan;
                }
                ...
                if(kecepatan + jumlah_kecepatan > 75){
                    System.out.println("kecepatan akan melebihi kecepatan maksimal di gigi 4");
                }
                else{
                    kecepatan += jumlah_kecepatan;
                }
                ...
                if(kecepatan + jumlah_kecepatan > 100){
                    System.out.println("kecepatan akan melebihi kecepatan maksimal di gigi 5");
                }
                else{
                    kecepatan += jumlah_kecepatan;
                }
...
public static void main(String[] args) {
        SimulasiMotorSinic JupiterIca = new SimulasiMotorSinic();

        JupiterIca.dinyalakan();
        JupiterIca.tambah_porseneling();
        JupiterIca.tambah_porseneling();
        JupiterIca.tambah_kecepatan(20);
        JupiterIca.kurangi_kecepatan(5);
        JupiterIca.kurangi_porseneling();
        JupiterIca.tambah_kecepatan(10);
        JupiterIca.tambah_kecepatan(10);
        JupiterIca.tambah_porseneling();
        JupiterIca.tambah_porseneling();
        JupiterIca.tambah_porseneling();
